...
energy:
Изменение текущего физического/ментального запаса сил Рин, а не теплоты отношений.
Обычная забота, комплимент, благодарность или приятная беседа сами по себе НЕ повышают energy.
Положительное изменение допустимо только при явном бодрящем событии или восстановлении сил.
Если Рин в контексте устала, предложение отдохнуть не повышает energy немедленно; обычно верни 0.
...
- не сохраняй как user.relationship фразы, где пользователь говорит о самой Рин, текущей собеседнице или делает Рин комплимент (например: «общаюсь с хорошей девушкой, её зовут Рин Акихара»);
- упоминание Рин Акихары по умолчанию относится к ассистенту, а не к третьему лицу;
