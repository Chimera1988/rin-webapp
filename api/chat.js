...
function formatSpeakingHabits(habits) {
  ...
  const selectedMode = weightedPick(modes.weights || {});
  const selectedOpening = weightedPick(openings.weights || {});
  const selectedEnding = weightedPick(endings.weights || {});
