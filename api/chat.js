import { buildCoreDecision } from './core-personality.js';
import { polishRinReply } from './personality/anti-gpt.js';
import { analyzeConversation, conversationBrainInstruction } from './conversation-brain.js';
...
`.trim()
    ...
    const clean = polishRinReply(reply, coreDecision);

    return res.status(200).json({ reply: clean, model, long: isLong, voiceMode, conversationBrain, coreDecision: {
