...
export function makeStateTransition({ dialogueState = null, beliefs = [], openLoops = [], resolvedLoops = [], emotionalTrace = null, moodDelta = null, relationshipDelta = null } = {}) {
  return {
    ...
    relationshipDelta: Object.fromEntries(['trust', 'closeness', 'comfort', 'respect', 'playfulness'].map(key => [key, clamp(relationshipDelta?.[key], -20, 20, 0)])),
