...
import { BELIEF_KINDS, normalizeBelief as normalizeEpistemicBelief } from '../epistemic-contract.js';
...
export const STATE_TRANSITION_SCHEMA = 'rin-state-transition-v3';
...
export function normalizeBelief(input = {}) {
  return normalizeEpistemicBelief(input);
}
...
export function normalizeBehaviorPolicy(input = {}) {
  ...
  return {
    ...
    persistentIntent: normalizeRinIntent(source.persistentIntent),
...
export function normalizeResponsePlan(input = {}) {
  ...
  return {
    ...
    rinIntent: normalizeRinIntent(input.rinIntent),
