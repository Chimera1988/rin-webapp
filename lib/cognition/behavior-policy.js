...
export function deriveBehaviorPolicy({ cognition = null, brain = null, coreDecision = null, memory = null, userText = '', history = [] } = {}) {
  ...
  const director = directConversation({ userText, brain, dialogueState: state, history, explicitReplyTarget: inputReplyTarget, characterIntent, persistentIntent, relationshipIntent });
  ...
  return {
    version: 'rin-behavior-policy-v3-scene-bound-intent',
    action,
    responseAct,
