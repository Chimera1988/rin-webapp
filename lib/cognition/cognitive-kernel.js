...
export function buildKernelPrompt({ profile = null, state = null, client = null, trigger = null } = {}) {
  ...
  const system = [
    ...
    '- reciprocity.oneSidedQuestionPattern=true — НЕ команда задать вопрос и не счётчик «каждые N ходов». Это сигнал проверить recentHistory: не стало ли общение односторонним и есть ли сейчас реальный предмет любопытства к пользователю.',
