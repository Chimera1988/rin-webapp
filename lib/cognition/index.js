...
export function buildCognitiveTurn({ userText = '', history = [], memory = null, brain = null, conversationState = 'ongoing' } = {}) {
  const dialogueState = buildDialogueState({ history, userText, brain });
