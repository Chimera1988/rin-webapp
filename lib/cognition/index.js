...
import { deriveTurnStateImpact } from './turn-state-impact.js';
...
export function buildStateTransition({ cognition = null, coreDecision = null, userText = '' } = {}) {
  ...
  const stateImpact = deriveTurnStateImpact(userText);
  return makeStateTransition({
    ...
    moodDelta: stateImpact.moodDelta,
    relationshipDelta: stateImpact.relationshipDelta,
    emotionalTrace
  });
}
