...
export function buildStateTransition({ cognition = null, coreDecision = null, affectiveTurn = null, responsePlan = null } = {}) {
  ...
  return makeStateTransition({
    ...
    rinIntent: responsePlan?.rinIntent || responsePlan?.behavior?.persistentIntent || null,
...
export { advancePersistentIntent, finalizePersistentIntentAfterReply, persistentIntentInstruction } from './persistent-intent.js';
