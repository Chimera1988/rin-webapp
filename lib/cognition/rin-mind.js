...
function compactState(state = null) {
  ...
  return {
    ...
    stickerState: sticker ? {
      ...
      hardAvailable: sticker.hardAvailable === true,
      ...
      recentFamilies: Array.isArray(sticker.recentFamilies) ? sticker.recentFamilies.slice(0, 5) : [],
      consecutiveStickerTurns: sticker.consecutiveStickerTurns ?? 0,
