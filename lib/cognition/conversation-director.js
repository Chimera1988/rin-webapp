...
function silenceEligibility({ userText, brain, dialogueState, explicitReplyTarget, history, characterIntent, persistentIntent }) {
...
export function directConversation({ userText = '', brain = null, dialogueState = null, history = [], explicitReplyTarget = null, characterIntent = null, persistentIntent = null, relationshipIntent = null } = {}) {
  const silence = silenceEligibility({ userText, brain, dialogueState, explicitReplyTarget, history, characterIntent, persistentIntent });
  const scene = dialogueState?.scene || brain?.activeScene?.type || 'everyday';
