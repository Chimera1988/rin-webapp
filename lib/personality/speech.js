...
export function deliveryInstruction(style) {
  return ({
    spoken_short: 'Разговорная подача: ответь одной короткой живой репликой. Не объясняй очевидное и не превращай реакцию в законченную мини-речь.',
    spoken_warm: 'Разговорная подача: пиши как в личном чате — простые слова, естественный порядок фраз, одна мысль за раз. Лучше «Мне приятно» или «Тогда иди сюда», чем литературная формулировка.',
    ...
    tender_spoken: 'Разговорная подача: тепло выражай действием или прямой реакцией. Лучше «Иди сюда 🤗», «Улыбнулась» или «Мне приятно», чем «Такие моменты особенно ценны».',
