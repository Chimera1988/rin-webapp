...
const MEMORIES_URL = new URL('../../data/canon/rin_memories.json', import.meta.url);
const BACKSTORY_URL = new URL('../../data/canon/rin_backstory.json', import.meta.url);
const TRIGGERS_URL = new URL('../../data/canon/rin_triggers.json', import.meta.url);
const PROFILE_URL = new URL('../../data/canon/rin_prompt_profile.json', import.meta.url);
