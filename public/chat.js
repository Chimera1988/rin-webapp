...
const RIN_BUILD_VERSION = '2026-07-30-settings-redesign-v1';
...
const personaLinks     = [...document.querySelectorAll('[data-open-persona]')];
...
personaLinks.forEach(button => {
  button.addEventListener('click', () => document.getElementById('openPersona')?.click());
});
