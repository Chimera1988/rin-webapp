...
const RIN_BUILD_VERSION = '2026-07-31-core-personality-v6.5';
...
if (!aiMoodApplied) {
  ...
  const res = await fetch('/api/chat', {
    ...
    if (data.coreDecision) {
      ...
      dbg(`core v6: userEmotion=${core.userEmotion || 'unknown'}; intent=${core.intent || 'unknown'}; style=${core.replyStyle || 'unknown'}`);
      dbg(
        'core state: ' +
      ...
      dbg('core v6: missing from API response');
    }
